...
from app.interface.http.schemas import CreateUserRequest, CreateUserResponse, ErrorResponse
...
async def create_user(
    ...
    if presenter.state is State.OK and isinstance(presenter.response, CreateUserOutputDTO):
